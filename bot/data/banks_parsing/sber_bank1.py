...
"""Парсинг Сбер СберВклад"""


class SberBank1:

    def __init__(self):
        self._bank_name = "Сбер Банк"
        self._bank_contribution = None
        self._url = "https://www.sberbank.ru/ru/person/contributions/deposits/sbervklad_a/"
    ...
    def get_contribution(self):
        ...
        if bank_info.status_code == 200:
            ...
            self._bank_contribution = self._response.xpath('//*[@id="page-main"]/div[1]/div/div[2]/div/div/div/div[1]/div[1]/div/div/div/div/div[1]/h1')
    ...
    def get_percent(self):
        percent_text = self._response.xpath(
            '//*[@id="page-main"]/div[1]/div/div[2]/div/div/div/div[1]/'
            'div[1]/div/div/div/div/div[2]/div[2]/div[1]/div[1]')[0].text_content()
