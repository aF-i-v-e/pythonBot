...
"""Парсинг Тинькофф вклад"""


class TinkoffBank1:

    def __init__(self):
        self._bank_name = "Тинькофф Банк"
        self._bank_contribution = "Тинькофф вклад"
        self._url = "https://www.tinkoff.ru/deposit/"
    ...
    def get_percent(self):
        percent_text = self._response.xpath(
            '/html/body/div[1]/div/div[3]/div/div[1]/div/div/div[2]/div[3]/div[1]/div[1]/div/strong/p'
        )[0].text_content()
    ...
    def get_start_sum(self):
        start_sum_text = self._response.xpath(
            '/html/body/div[1]/div/div[3]/div/div[1]/div/div/div[2]/div[3]/div[3]/div[1]/div/strong/p'
        )[0].text_content()
        start_sum = start_sum_text.split(' ')[0]
        return int(start_sum) * 1000

    def get_months_number(self):
        months_number_text = self._response.xpath(
            '/html/body/div[1]/div/div[3]/div/div[1]/div/div/div[2]/div[3]/div[2]/div[1]/div/strong/p'
        )[0].text_content()
        months_number = months_number_text.split(' ')[0].split('\xa0')[1]
        return int(months_number)
