...
"""Парсинг ВТБ «Вклад Первый»"""


class VtbBank1:

    def __init__(self):
        self._bank_name = "ВТБ Банк"
        self._bank_contribution = None
        self._url = "https://www.vtb.ru/personal/vklady-i-scheta/vklad-perviy/"
    ...
    def get_contribution(self):
        ...
        if bank_info.status_code == 200:
            ...
            self._bank_contribution = self._response.xpath(
                '/html/body/div[1]/section[2]/div/div/div/div/div[1]/div/div/div[1]/h1')
    ...
    def get_percent(self):
        percents_text = self._response.xpath(
            '//*[@id="section-id"]/div/div[2]/div/div[1]/div/div/div/div[1]/div[3]/div/div/div[2]/div/div/div/p'
        )[0].text_content()
        return float(percents_text.replace(',', '.')[:-1])

    def get_start_sum(self):
        start_sum_text = self._response.xpath(
            '//*[@id="section-id"]/div/div[2]/div/div[1]/div/div/div/div[1]/div[2]/div/div/div[1]/div/div/div/p'
        )[0].text_content()
    ...
    def get_months_number(self):
        months_number_text = self._response.xpath(
            '//*[@id="section-id"]/div/div[2]/div/div[1]/div/div/div/div[1]/div[3]/div/div/div[1]/div/div/div/p'
        )[0].text_content()
